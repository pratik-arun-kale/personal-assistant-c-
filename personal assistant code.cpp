...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning pratik"<<endl;
        string phrase = "Good Morning pratik";
        ...
        cout<< "Good Afternoon pratik"<<endl;
        string phrase = "Good Afternoon pratik";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening pratik"<<endl;
        string phrase = "Good Evening pratik";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE PRATIK|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE PRATIK";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="pratik")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you pratik...."<<endl<<endl;

                string phrase = "How can i help you pratik";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"I'm a personal assistant created by pratik !!!"<<endl;
                    string phrase = "I'm a personal assistant created by pratik kale !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(command=="bye" || command=="exit")
                {
                    ...
                    string phrase = "Good Bye pratik, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
